document.addEventListener('DOMContentLoaded', () => {
    // --- DATA ---
    const userData = {
        name: "İMRAN <span class='highlight'>YUSİFOV</span>",
        title: "STUDENT",
        contact: [
            { icon: "phone.png", text: "+994 51 393 49 06" },
            { icon: "email.png", text: "imranyusifov403@gmail.com" },
            { icon: "location.png", text: "Azerbaijan/Baku" }
        ],
        socialMedia: [
            { icon: "instagram.png", text: "imranyusifov" },
            { icon: "tik-tok.png", text: "imran.yusifov1" },
            { icon: "github.png", text: "GitHub" }
        ],
        education: [
            { period: "2013 - 2024", school: "Alisoltanli village secondary school named after M. Aliyev" },
            { period: "2024 - 2025", school: "AzTU - Information Security" }
        ],
        skills: ["Camera Operation", "Web Development"],
